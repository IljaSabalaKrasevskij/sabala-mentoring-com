          ...
          <div className="order-2 lg:order-1 flex flex-col items-start text-center lg:text-left">
            ...
            <ScrollReveal delay={0.2}>
              <p className="text-warm-steel text-xl md:text-2xl leading-relaxed max-w-xl mb-10 mx-auto lg:mx-0">
                Eine Seite, die unverwechselbar deine ist. Mit Personal-Brand-Interview, klarer Positionierung und einem ganz persönlichen Element, das man so noch nie gesehen hat.
              </p>
            </ScrollReveal>
      ...
      <section className="py-32 md:py-40 lg:py-48 px-6 sm:px-12 md:px-24 bg-warm-canvas border-b border-whisper-border">
        <div className="max-w-[1400px] mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 text-left">
              ...
              <ScrollReveal delay={0.4} className="lg:col-span-4 relative rounded-3xl overflow-hidden border border-whisper-border shadow-2xl h-[400px] md:h-auto min-h-[400px] group bg-warm-canvas flex items-center justify-center">
            ...
            <ScrollReveal>
               ...
               <div className="flex flex-col items-center mb-0">
                  ...
                  <div className="text-sm md:text-base text-warm-steel font-satoshi tracking-wide">
                     netto <span className="mx-2 opacity-40">·</span> Personal-Brand-Interview <span className="mx-2 opacity-40">·</span> Positionierung &amp; Strategie
                  </div>
               </div>
         ...
         <div className="max-w-[1000px] mx-auto">
            ...
            <div className="space-y-6">
               <ScrollReveal delay={0.1} className="bg-white border border-whisper-border p-8 rounded-3xl transition-shadow hover:shadow-lg">
                  ...
                  <p className="text-warm-steel leading-relaxed">Wir bauen deine Seite auf einer modernen, hochperformanten Plattform — kein WordPress, keine Plugin-Pflege, keine Cookie-Banner-Sorgen. Du hast mit der Technik nichts mehr zu tun, ich übernehme das komplett. Server in Deutschland, DSGVO-konform, schnell und sicher.</p>
               </ScrollReveal>
               ...
               <ScrollReveal delay={0.2} className="bg-white border border-whisper-border p-8 rounded-3xl transition-shadow hover:shadow-lg">
                  ...
                  <p className="text-warm-steel leading-relaxed">Fast nichts. Alles, was du final benötigst, ist deine Einmal-Investition und eine eigene Domain. Den gesamten Prozess — von Personal-Brand-Interview über Positionierung, Text und Design bis zum Launch — übernehme ich schlüsselfertig.</p>
               </ScrollReveal>
          ...
          <ScrollReveal>
             <div className="flex flex-col items-center text-center max-w-[820px] mx-auto mb-16 md:mb-20">
               <div className="px-5 py-2 rounded-full border border-night-gold/30 bg-night-gold/5 backdrop-blur-md mb-8 inline-block">
                 <span className="font-geist text-[0.65rem] md:text-sm tracking-[0.2em] uppercase text-night-gold font-medium">Sabala Service · Nach dem Launch</span>
               </div>
               <h2 className="font-instrument text-[clamp(2rem,4vw,3.5rem)] text-white leading-[1.1] mb-6">
                 Damit deine Seite <span className="italic text-night-gold">wirklich performt.</span>
               </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             <ScrollReveal delay={0.1} className="group relative rounded-[2rem] p-[1px] overflow-hidden">
                ...
                <div className="relative h-full bg-[#0A0A0A] p-8 md:p-10 rounded-[calc(2rem-1px)] flex flex-col items-start border-t border-white/5">
                   <h3 className="font-instrument text-2xl text-white mb-2">Mini · Anpassungen</h3>
                   <div className="font-geist text-night-gold tracking-widest text-sm uppercase mb-6">49,- € / Monat</div>
                   <p className="font-satoshi text-white/60 mb-8 leading-relaxed">Der ruhige Begleiter für kleine, regelmäßige Anpassungen. Ohne Analyse, ohne Schnickschnack.</p>
                   <ul className="space-y-4 font-satoshi text-white/80 w-full mb-8">
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Kleine Text- und Bildänderungen — schnell erledigt</span></li>
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Direkter Ansprechpartner per Mail</span></li>
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Sicheres Hosting & laufende Pflege deiner Sabala-Seite</span></li>
                   </ul>
                </div>
             </ScrollReveal>
             ...
             <ScrollReveal delay={0.2} className="group relative rounded-[2rem] p-[1px] overflow-hidden lg:-translate-y-4">
                ...
                <div className="relative h-full bg-[#0E0B05] p-8 md:p-10 rounded-[calc(2rem-1px)] flex flex-col items-start">
                   ...
                   <h3 className="font-instrument text-3xl text-white mb-2 relative z-10">Plus · mit Analyse</h3>
                   <div className="font-geist text-night-gold tracking-widest text-sm uppercase mb-6 relative z-10">69,- € / Monat</div>
                   <p className="font-satoshi text-white/70 mb-8 leading-relaxed relative z-10">Du willst sehen, was wirklich passiert. Inklusive Analyse-Tool und monatlichem Bericht.</p>
                   <ul className="space-y-4 font-satoshi text-white/90 w-full mb-8 relative z-10">
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Alles aus dem Mini-Paket</span></li>
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Analyse-Tool aktiv geschaltet (DSGVO-konform)</span></li>
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span><strong className="text-white">Monatsbericht</strong>: Was funktioniert, was nicht, was tun</span></li>
                   </ul>
                </div>
             </ScrollReveal>
             ...
             <ScrollReveal delay={0.3} className="group relative rounded-[2rem] p-[1px] overflow-hidden md:col-span-2 lg:col-span-1">
                <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent" />
                <div className="relative h-full bg-[#0A0A0A] p-8 md:p-10 rounded-[calc(2rem-1px)] flex flex-col items-start border-t border-white/5">
                   <h3 className="font-instrument text-2xl text-white mb-2">Premium · mit Strategie-Call</h3>
                   <div className="font-geist text-night-gold tracking-widest text-sm uppercase mb-6">149,- € / Monat</div>
                   <p className="font-satoshi text-white/60 mb-8 leading-relaxed">Für alle, die ihre Seite aktiv weiterentwickeln — mit persönlichem Sparring zur Auswertung der Analyse.</p>
                   <ul className="space-y-4 font-satoshi text-white/80 w-full mb-8">
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Alles aus dem Plus-Paket</span></li>
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span><strong className="text-white">30-Min-Strategie-Call pro Monat</strong> — Analyse besprechen, nächste Schritte festlegen</span></li>
                     <li className="flex items-start gap-4"><span className="text-night-gold mt-1">✦</span><span>Höchste Priorität bei Anpassungen</span></li>
                   </ul>
                </div>
             </ScrollReveal>
          </div>
