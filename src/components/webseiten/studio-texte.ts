...
const de = {
  ...
  zurueck: "Zum Schaufenster",
  weiterlesen: "Auf der Webseite weiterlesen",
  navigationHinweis: "Wähle deinen nächsten Raum.",
...
const en: typeof de = {
  ...
  navigationHinweis: "Choose your next room.",
