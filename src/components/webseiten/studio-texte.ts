...
const de = {
  ...
  raum: { window: "Schaufenster", reception: "Empfang", gallery: "Galerie" },
  ueberspringen: "Rundgang überspringen",
  zurueck: "Zurück zum Schaufenster",
  weiterlesen: "Auf der Webseite weiterlesen",
  navigationHinweis: "Entdecke die Arbeiten in der Galerie.",
  ...
  fragen: [
    ...
    { question: "Zeig mir deine Arbeit.", answer: "Sehr gern. Komm mit in die Galerie. Ich zeige dir ein paar Ergebnisse aus den Sabala Studios." },
  ],
};
...
const en: typeof de = {
  ...
  raum: { window: "Shop window", reception: "Reception", gallery: "Gallery" },
  ueberspringen: "Skip the tour",
  zurueck: "Back to the window",
  weiterlesen: "Continue on the website",
  navigationHinweis: "Explore the work in the gallery.",
  ...
  fragen: [
    ...
    { question: "Show me your work.", answer: "Gladly. Come with me to the gallery. I will show you a few results from Sabala Studios." },
  ],
};
