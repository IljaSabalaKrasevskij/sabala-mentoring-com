...
export const COFFEE_COPY = {
  de: {
    answerTitle: "Dann komm mit.", room: "Auf einen Kaffee", host: "Dein Gastgeber", title: "Wie trinkst du deinen Kaffee?",
    ...
    replies: {
      black: "Schwarz. Sehr gern. Komm mit, ich zeige dir unseren Tisch.",
      sugar: "Mit etwas Zucker. Sehr gern. Komm, nebenan sitzen wir gemütlicher.",
      none: "Natürlich. Nimm einfach so Platz. Ich freue mich auf deine Ideen.",
    },
    walk: "Gehen wir zum Tisch", walking: "Komm mit. Nebenan haben wir Ruhe.",
  ...
  en: {
    answerTitle: "Come with me.", room: "Join me for a coffee", host: "Your host", title: "How do you take your coffee?",
    ...
    replies: {
      black: "Black it is. Come with me, I’ll show you to our table.",
      sugar: "With a little sugar. Of course. Come, it’s more comfortable next door.",
      none: "Of course. Come and take a seat. I’d love to hear your ideas.",
    },
    walk: "Let’s go to the table", walking: "Come with me. It’s quiet next door.",
