...
const FAQ = [
  ...
  { q: "Wie funktioniert die Bild- und Video-Generierung?", a: "Über deinen eigenen Bild-Schlüssel (KIE): kostenlos anlegen, danach zahlst du nur die Nutzung, etwa sechs Cent pro Bild. So behältst du die Kosten selbst in der Hand. Das Setup trägt den Schlüssel für dich ein, damit die Bilder auf Zuruf direkt funktionieren." },
