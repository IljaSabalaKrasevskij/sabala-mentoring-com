---
name: design-tokens
description: Design token reference for the Taste Design System. Defines the exact color palette, typography rules, component styles, layout principles, responsive rules, motion specs, and anti-patterns. Use as the single source of truth when generating premium frontend interfaces.
---
